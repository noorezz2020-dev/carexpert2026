...
def change_car_color(image_path, target_color):
    ...
    try:
        ...
        # ألوان RGB للهدف
        color_map = {
            "أحمر": (255, 50, 50), "أزرق": (50, 50, 255), "أسود": (30, 30, 30),
            "أبيض": (245, 245, 245), "أصفر": (255, 255, 50), "أخضر": (50, 255, 50),
            "فضي": (192, 192, 192), "ذهبي": (255, 215, 0), "برتقالي": (255, 165, 0),
            "بنفسجي": (128, 0, 128)
        }
...
def add_accessory_to_car(image_path, accessory_type, position):
    ...
    try:
        ...
        accessory_colors = {
            "جنوط رياضية": (200, 200, 200), "جناح خلفي": (255, 100, 100),
            "إضاءة LED": (255, 255, 100), "مصد أمامي": (100, 100, 200),
